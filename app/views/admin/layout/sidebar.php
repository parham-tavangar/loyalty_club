...
<aside :class="sidebarOpen ? 'translate-x-0' : 'translate-x-full lg:translate-x-0'"
    ...
    <div class="flex items-center justify-between h-24 px-6 border-b border-border/50">
        <div class="flex items-center gap-3">
            <div
                class="w-11 h-11 rounded-2xl bg-gradient-to-br from-coral-400 to-coral-600 text-white flex items-center justify-center shadow-glow-coral">
                <!-- آیکون لوگو -->
    ...
    <nav class="flex-1 overflow-y-auto py-6 px-4 space-y-2 relative">
        ...
        <a href="<?= URL_ROOT ?>admin-panel"
            class="flex items-center gap-3 px-4 py-3.5 rounded-2xl transition-all duration-300 bg-gradient-to-r from-coral-500 to-coral-400 text-white shadow-glow-coral hover:scale-[1.02]">
        ...
        <div x-data="{ open: false }">
            <button @click="open = !open"
                class="w-full flex items-center justify-between px-4 py-3.5 rounded-2xl transition-all duration-200 hover:bg-indigo-50 text-muted hover:text-indigo-600 group">
                <div class="flex items-center gap-3">
                    <svg class="w-5 h-5 transition-colors group-hover:text-indigo-500" fill="none" stroke="currentColor"
                        viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <svg :class="open ? 'rotate-180' : ''"
                    class="w-4 h-4 transition-transform text-muted group-hover:text-indigo-500" fill="none"
...
<!-- ========================================== -->
<!-- شروع کانتینر محتوای اصلی (این بخش جا افتاده بود) -->
<!-- ========================================== -->
