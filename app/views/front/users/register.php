...
<head>
  ...
  <title>ثبت‌نام | باشگاه مشتریان</title>
      ...
      <div class="rounded-3xl border border-border bg-surface overflow-hidden shadow-sm">
        ...
        <div class="p-6 sm:p-10">
          ...
          <div class="text-center mb-8">
            ...
            <h1 class="text-2xl sm:text-3xl font-extrabold">ثبت‌نام</h1>
            <p class="mt-2 text-sm text-muted">اطلاعات زیر را تکمیل کنید</p>
          </div>

          <!-- Form -->
          <form action="<?= URL_ROOT ?>users/store" method="post" class="space-y-5">
            <!-- Full Name -->
            <div>
              <label for="name" class="block text-sm font-medium mb-2">اسم و فامیل</label>
              <input type="text" id="name" name="name" placeholder="مثلاً: علی رضایی" autocomplete="name" class="w-full h-12 rounded-xl border border-border bg-white px-4 text-sm outline-none
            ...
            <div>
              ...
              <input type="text" id="mobile" name="mobile" placeholder="مثلاً: 09123456789" inputmode="numeric"
                autocomplete="tel" class="w-full h-12 rounded-xl border border-border bg-white px-4 text-sm outline-none
                       focus:ring-2 focus:ring-coral-200 focus:border-coral-300" />
              <p class="mt-2 text-xs text-muted">شماره را بدون فاصله وارد کنید.</p>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input type="password" id="password" name="password" placeholder="رمز عبور" autocomplete="new-password"
                  class="w-full h-12 rounded-xl border border-border bg-white px-4 text-sm outline-none
                       focus:ring-2 focus:ring-coral-200 focus:border-coral-300" />
              ...
              <div>
                <label for="password_confirmation" class="block text-sm font-medium mb-2">تکرار رمز عبور</label>
                <input type="password" id="password_confirmation" name="password_confirmation"
                  placeholder="تکرار رمز عبور" autocomplete="new-password" class="w-full h-12 rounded-xl border border-border bg-white px-4 text-sm outline-none
                       focus:ring-2 focus:ring-coral-200 focus:border-coral-300" />
            ...
            <!-- Birthday -->
            <div>
              <label for="birthday" class="block text-sm font-medium mb-2">تاریخ تولد (شمسی)</label>
              <input type="text" id="birthday" name="birthday" placeholder="مثلاً: 1405/01/02" autocomplete="bday"
                class="w-full h-12 rounded-xl border border-border bg-white px-4 text-sm outline-none
                       focus:ring-2 focus:ring-coral-200 focus:border-coral-300" />
              <p class="mt-2 text-xs text-muted">فرمت: 1405/01/02</p>
          ...
          <div class="mt-6 text-center">
            <p class="text-sm text-muted">
              ...
              <a href="<?= URL_ROOT ?>users/login-form"
